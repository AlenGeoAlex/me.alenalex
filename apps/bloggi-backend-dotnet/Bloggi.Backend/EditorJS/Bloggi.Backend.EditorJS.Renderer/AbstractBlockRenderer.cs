...
public abstract class AbstractBlockRenderer<TData>(ILogger<AbstractBlockRenderer> logger, InlineProcessor inlineProcessor) : AbstractBlockRenderer(logger, inlineProcessor), IBlockRenderer<TData> where TData : class
{
